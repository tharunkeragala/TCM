...
exports.startRecording = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: 'Failed to start recorder', error: err.message });
  }
};
...
exports.stopRecording = async (req, res) => {
  try {
    ...
    res.status(500).json({ success: false, message: 'Failed to stop recorder', error: err.message });
  }
};
